...
/**
 * kool_weather_shortcode() associated to the shortcode [KoolWeather],
 * it feeds the location to the query and sends the results to the 
 * weather processor (kool_weather_JSON2HTML)
 */
